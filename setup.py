...
NAME = "ZenPacks.seclan.as400Comtek"
VERSION = "1.0.0"
AUTHOR = "Marko Virtanen"
LICENSE = ""
NAMESPACE_PACKAGES = ['ZenPacks', 'ZenPacks.seclan']
PACKAGES = ['ZenPacks', 'ZenPacks.seclan', 'ZenPacks.seclan.as400Comtek']
INSTALL_REQUIRES = []
COMPAT_ZENOSS_VERS = ""
PREV_ZENPACK_NAME = ""
# STOP_REPLACEMENTS
